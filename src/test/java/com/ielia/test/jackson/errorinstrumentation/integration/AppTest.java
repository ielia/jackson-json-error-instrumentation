package com.ielia.test.jackson.errorinstrumentation.integration;

import com.ielia.test.jackson.errorinstrumentation.JSONMutationInstrumentator;
...
public class AppTest extends AbstractTestNGSpringContextTests {
    ...
    @Test(groups = "integration", dataProvider = "error-cases")
    ...
    @Test(groups = "integration", dataProvider = "error-cases")
    public void testPost2(String json) throws Exception {
        logger.info("SENT:                 {}", json);
        mockMVC.perform(
                post("/foos/check")
                        .content(json)
